...
/*
  ...
  - Manual test (Android/XBrowser):
    1) Enable the script on a long article page.
    2) Convert to Markdown and confirm the download/share flow.
    3) Disable the script and confirm no conversion actions run.
*/
