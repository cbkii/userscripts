...
/*
  LOAD PRIORITY: 10 (Document Processing)
  Site-specific export tool that runs at document-idle after page is fully interactive.
...
(() => {
  ...
  const MAX_DATA_URL_FILE_SIZE_BYTES = 2097152;
